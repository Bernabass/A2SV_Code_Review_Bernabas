...
**Problem:** [Power-Mod-Power](https://www.hackerrank.com/challenges/python-power-mod-power/problem?isFullScreen=true)
...
**Input Format** The first line contains , the second line contains , and the third line contains .
